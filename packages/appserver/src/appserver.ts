...
import { getProStatusHandler } from "./handlers/space.roomy.user.getProStatus.ts";
...
export function buildRouter(
  ...
  return new XrpcRouter(authVerifier)
    ...
    .query("space.roomy.user.getProStatus", {
      handler: getProStatusHandler,
      paramsSchema: schemas.queries.getProStatus.Params,
      outputSchema: schemas.queries.getProStatus.Response,
    })
